...
@ContextConfiguration(classes = { GsrsEntityTestConfiguration.class, GsrsControllerConfiguration.class},
        initializers= { AbstractClinicalTrialJpaEntityTestSuperClass.Initializer.class}
)
//@SpringBootTest

@Import({AbstractClinicalTrialJpaEntityTest.TestConfig.class,  GsrsClinicalTrialModuleAutoConfiguration.class})
public abstract class AbstractClinicalTrialJpaEntityTestSuperClass extends AbstractGsrsJpaEntityJunit5Test {
    @TestConfiguration
