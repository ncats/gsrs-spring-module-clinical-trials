...
@EnableJpaRepositories(
        entityManagerFactoryRef = ClinicalTrialDataSourceConfig.NAME_ENTITY_MANAGER,
        transactionManagerRef = ClinicalTrialDataSourceConfig.NAME_TRANSACTION_MANAGER,
...
public class ClinicalTrialDataSourceConfig {
    ...
    protected static final String[] BASE_PACKAGES = new String[] {"gov.nih.ncats2.clinicaltrial"};
    protected static final String PERSIST_UNIT = "clinicaltrial";
