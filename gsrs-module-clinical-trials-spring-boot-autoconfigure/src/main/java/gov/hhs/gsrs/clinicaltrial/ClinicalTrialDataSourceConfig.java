...
@EnableJpaRepositories(
        ...
        basePackages = {"gov.hhs.gsrs.clinicaltrial"}
)
@Slf4j
public class ClinicalTrialDataSourceConfig extends GSRSDataSourceConfig  {
    ...
    protected static final String[] BASE_PACKAGES = new String[] {"gov.hhs.gsrs.clinicaltrial"};
